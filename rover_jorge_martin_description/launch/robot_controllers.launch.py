...
def generate_launch_description():
  ...
  pkg_share_folder = get_package_share_directory('rover_jorge_martin_description')
  ...
  arm_pkg_share_folder = get_package_share_directory('rover_jorge_martin_moveit_config')
