...
def generate_launch_description():
    ...
    pkg_path = get_package_share_directory('rover_jorge_martin_description')
    ...
    model_path = get_model_paths(['rover_jorge_martin_description'])

    robot_description_launcher = IncludeLaunchDescription(
        PathJoinSubstitution(
            [FindPackageShare("rover_jorge_martin_moveit_config"), "launch", "rsp.launch.py"]
        ),
    )
    ...
    gz_image_bridge_node = Node(
        ...
        arguments=[
            "/rover/front_camera/image_raw",
            "/rover/ee_camera/image_raw"
        ],
        output="screen",
        parameters=[
            {'use_sim_time': True,
